...
const DashboardGuru = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.welcomeText}>Welcome, Aditya !</Text>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.menuButton}>
          <Text style={styles.menuTitle}>Absen dan Daftar Absensi Siswa</Text>
        </View>

        {/* Menu Items */}
        <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/guru/AbsensiSiswa')}>
